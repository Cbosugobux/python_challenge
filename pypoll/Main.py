...
file_to_load = os.path.join("/workspaces","python_challenge", "pypoll", "Resources", "election_data.csv")  # Input file path
file_to_output = os.path.join("/workspaces", "python_challenge","pypoll", "Analysis", "election_analysis.txt")  # Output file path
