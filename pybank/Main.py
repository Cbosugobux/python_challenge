...
file_to_load = os.path.join("/workspaces", "python_challenge", "pybank", "Resources", "budget_data.csv")  # Input file path
file_to_output = os.path.join("/workspaces", "python_challenge", "pybank", "Analysis", "budget_analysis.txt")  # Output file path
